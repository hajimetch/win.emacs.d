...
;;; abbrev file
(set-variable 'abbrev-file-name "//Mac/Dropbox/Emacs/abbrev_defs")
...
(use-package skk :no-require
  :init
  (set-variable 'skk-user-directory "//Mac/Dropbox/Emacs/ddskk/")
  ...
  ;; 基本辞書
  (set-variable 'skk-large-jisyo "//Mac/Dropbox/Emacs/ddskk/SKK-JISYO.L")

  ;; チュートリアルのパス
  (set-variable 'skk-tut-file "//Mac/Dropbox/Emacs/ddskk/SKK.tut")
...
(with-eval-after-load 'org
  ...
  (set-variable 'org-directory "//Mac/Dropbox/Emacs/org/")
  (set-variable 'org-default-notes-file "//Mac/Dropbox/Emacs/org/default.org")
  ...
  (set-variable 'org-refile-targets '(("//Mac/Dropbox/Emacs/org/task.org" :maxlevel . 3)))
  (set-variable 'org-archive-location "//Mac/Dropbox/Emacs/org/archive.org::datetree/")
...
(use-package org-bullets :ensure
  ...
  (set-face-attribute 'org-level-3 nil :family "Meiryo UI"))
...
(use-package howm :ensure :demand
  ...
  :config
  (set-variable 'howm-directory "//Mac/Dropbox/Emacs/howm/")
