...
(use-package org
  ...
  (org-directory "//Mac/Dropbox/Emacs/org/") ; デフォルトディレクトリ
  (org-default-notes-file "//Mac/Dropbox/Emacs/org/default.org")
                                        ; デフォルトファイル名
  ...
  (org-refile-targets '(("//Mac/Dropbox/Emacs/org/task.org" :maxlevel . 3)))
  (org-archive-location "//Mac/Dropbox/Emacs/org/archive.org::datetree/")
...
(use-package howm :ensure :demand
  ...
  :custom
  (howm-directory "//Mac/Dropbox/Emacs/howm/") ; ファイルパス
...
(use-package open-junk-file :ensure
  ...
  :custom (open-junk-file-format "//Mac/Dropbox/Emacs/junk/%Y-%m-%d-%H%M%S."))
